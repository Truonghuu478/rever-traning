<template>
  <form class="form-group card text-left p-3">
    <label class="font-weight-bold">Bài 192: Hãy liệt kê các  giá trị trong mảng 1 chiều các số nguyên có chữ số đầu tiên là số chẵn</label>
    <div class="d-flex">
...
export default {
  ...
  methods: {
    ...
    add() {
      if (this.validate(this.n, "B192",0)) {
    ...
    perform() {
      ...
      this.results = results ? "Mảng có các giá trị bắt đầu bằng chữ số chẵn là : " + results : "Mảng không có giá trị thoả điều kiện"
