<template>
  <form class="form-group card text-left p-3">
    <label class="font-weight-bold">Bài 202: Tính tổng các giá trị có chữ số đầu tiên là chữ số lẻ trong mảng 1 chiều các số nguyên</label>
    <div class="d-flex">
...
export default {
  ...
  methods: {
    ...
    add() {
      if (this.validate(this.n, "B202",0)) {
