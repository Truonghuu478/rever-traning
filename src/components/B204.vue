<template>
  <form class="form-group card text-left p-3">
    <label class="font-weight-bold">Bài 204: Tính tổng các giá trị lớn hơn giá trị đứng liền trước nó trong mảng 1 chiều các số thực</label>
    <div class="d-flex">
