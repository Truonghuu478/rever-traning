...
<template>
  <form class="form-group  text-left p-3" @submit.prevent="submit">
    <label class="font-weight-bold">Bài 103: Viết chương trình nhập vào 1 ngày ( ngày, tháng, năm). Tìm ngày trước ngày vừa nhập (ngày, tháng, năm)</label>
    <div class="d-flex ">
    ...
    findTheNextDay(day,month,year){
      ...
      let nextYear = year
        if(day === 1){
          ...
          nextDay = this.dayOfMonth(nextMonth,nextYear)
        }else{
          nextDay --
        }
