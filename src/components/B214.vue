<template>
  <form class="form-group card text-left p-3">
    <label class="font-weight-bold"> Bài 214: Tính trung bình nhân các giá trị dương có trong mảng 1 chiều các số thực</label>
    <div class="d-flex">
...
export default {
  ...
  methods: {
    ...
    perform() {
      ...
      this.results = "Trung bình nhân các giá trị dương là : "+ Math.floor(T/count)
      this.isSubmit = true;
    },
  },
};
