<template>
  <form class="form-group card text-left p-3">
    <label class="font-weight-bold">Bài 185: Hãy liệt kê các vị trí mà giá trị tại đó là số chính phương trong mảng 1 chiều các số nguyên</label>
    <div class="d-flex">
...
export default {
  ...
  methods: {
    ...
    add() {
      if (this.validate(this.n, "B185", 0)) {
    ...
    perform() {
      ...
      this.results = result ? `Danh sách vị trí có giá trị là số chính phương :` + result : `Danh sách không có giá trị thoả điều kiện`;
      this.isSubmit = true;
    },
  },
};
