<template>
  <form class="form-group card text-left p-3">
    <label class="font-weight-bold">Bài 200: Tính tổng các phần tử trong mảng</label>
    <div class="d-flex">
...
export default {
  ...
  methods: {
    ...
    perform() {
      ...
      this.results = "Tổng các giá trị phần tử trong mảng là : "+s
      this.isSubmit = true;
    },
  },
};
