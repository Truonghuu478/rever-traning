<template>
  <form class="form-group card text-left p-3">
    <label class="font-weight-bold">Bài 210: Tính tổng các giá trị có chữ số đầu tiên là chữ số chẵn trong mảng các số nguyên</label>
    <div class="d-flex">
...
export default {
  ...
  methods: {
    ...
    perform() {
      ...
      this.results = "Tổng các giá trị có chữ số đầu tiên là chẵn là : "+ s
      this.isSubmit = true;
    },
  },
};
